...
namespace K_Means.masterDataSetTableAdapters {
    ...
    public partial class databasesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::K_Means.Properties.Settings.Default.masterConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        name, database_id\r\nFROM            sys.databases\r\nWHERE        (dat" +
                "abase_id >= 5) AND (NOT (name LIKE N\'ReportServer%\'))\r\nORDER BY name";
